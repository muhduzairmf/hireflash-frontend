...
document.title = "Interview List - Hireflash";
...
async function removeCandidateInterview(candidate_profile_id) {
    const jobId = router.currentRoute.value.params.jobId;
    ...
    if (response.status !== 200) {
        ...
        if (response2.status !== 200) {
            ...
            toggleToastMsg(
                "Successfully removed the candidate from interview list."
            );
        }
    }
}
...
if (successRemove.value === "interview") {
    toggleToastMsg("Successfully removed the candidate from interview list.");
    successRemove.value = "";
}
</script>
    ...
    <div class="max-w-7xl mx-auto px-6 max-md:px-3">
        ...
        >
            ...
            <div class="mt-4 flex justify-between max-md:block">
                <div>
                    <TitleBorder title="Interview List" />
                </div>
                <select
            ...
            <template v-if="isLoaded">
                <template v-if="interviewList.length > 0">
                    <div class="mt-4" v-for="interview in interviewList">
                                ...
                                <div class="flex flex-col">
                                    <router-link
                                        v-bind:to="
                                            ...
                                            interview.candidate_profile.id
                                        "
                        ...
                        >
                            ...
                            <div class="flex flex-col gap-1">
                                ...
                                >
                                    {{ interview.candidate_profile.user.name }}
                                </router-link>
                                <p
                                    v-if="
                ...
                <div class="mt-4 py-4" v-else>
                    <h4 class="text-lg text-indigo-300 italic">
                        No candidate planned for interview...
                    </h4>
                </div>
            </template>
